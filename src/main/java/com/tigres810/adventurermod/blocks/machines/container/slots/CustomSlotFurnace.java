...
public class CustomSlotFurnace extends Slot {

	private static IInventory emptyInventory = new InventoryBasic("[Null]", true, 0);
    private final IItemHandler itemHandler;
    private final int index;

    public CustomSlotFurnace(IItemHandler itemHandler, int index, int xPosition, int yPosition)
    {
    ...
    public boolean isItemValid(ItemStack stack) {
    	return TileEntityFluxCrafter.isItemOutput(stack);
    }
