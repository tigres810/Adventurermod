...
public class BlockEntityFluxPipeSideConnector extends BlockBase {
	...
	public BlockEntityFluxPipeSideConnector(String name, Material material) {
		super(name, material);
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
		return new TileEntityFluxPipeSideConnector();
	}
	
	@Override
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		TileEntityFluxPipeSideConnector tileentity = (TileEntityFluxPipeSideConnector)worldIn.getTileEntity(pos);
