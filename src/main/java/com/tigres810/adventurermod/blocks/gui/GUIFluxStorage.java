...
public class GUIFluxStorage extends GuiContainer
{
	...
	public GUIFluxStorage(InventoryPlayer player, TileEntityFluxStorage tileentity) 
	{
		super(new ContainerFluxStorage(player, tileentity));
		this.player = player;
